...
| Retrieve | `T-036` | active index, active profile, query, filters | hybrid ranked results with score/provenance/version | topic, paper-project, writing workflows | profile contract stable; stale active index warning is visible |
