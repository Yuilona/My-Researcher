...
| v1c N2 | `topic-selection.v1c.generate-promotion-support.v1` | `n2_bounded_micro_debate.promotion_supporter_draft` | implemented L1-L3 through `TopicSelectionV1cN2BoundedDebateRuntimeService -> AgentOrchestrator` plus admission through `TopicSelectionV1cN2BoundedDebateAdmissionService`; v1c harness and Prisma smoke now use this path | support-only draft before critic/repair/final synthesis; cannot create N3 gate, human decision, bridge, or recheck | `v1c_n2_bounded_promotion_support`; owner v1c bounded-debate runtime/admission services; MUST consume frozen N1 promotion input snapshot refs/hashes and preserve claim ceiling, evidence support map, risks, blockers, recheck hints, allowed refs, and source-health warnings | `topic-selection.v1c.promotion-support.bounded-micro-debate.v1`; provider-canary profile remains canary-only; `TopicSelectionV1cBoundedMicroDebateRoleOrFinal@v1`; prompt-index L3 smoke passed via `pnpm topic-selection:v1c-n2-runtime-smoke` |
| v1c N2 | `topic-selection.v1c.generate-promotion-support.v1` | `n2_bounded_micro_debate.reviewer_critic_review` | implemented L1-L3 through `TopicSelectionV1cN2BoundedDebateRuntimeService -> AgentOrchestrator`; prior supporter draft artifact hash is dynamic material and admission-checked | support-only critique before repair/final synthesis; critic findings cannot become authority and must be resolved by final synthesis | `v1c_n2_bounded_promotion_support` + supporter draft ref/hash as dynamic material; owner v1c bounded-debate runtime/admission services | `topic-selection.v1c.promotion-support.bounded-micro-debate.v1`; provider-canary profile remains canary-only; `TopicSelectionV1cBoundedMicroDebateRoleOrFinal@v1`; prompt packet identity includes prior-role hash material |
| v1c N2 | `topic-selection.v1c.generate-promotion-support.v1` | `n2_bounded_micro_debate.promotion_supporter_repair` | implemented L1-L3 through `TopicSelectionV1cN2BoundedDebateRuntimeService -> AgentOrchestrator`; prior supporter/critic artifact hashes are dynamic material and admission-checked | support-only repair before final synthesis; repair actions cannot override deterministic N3 gate or allowed refs | `v1c_n2_bounded_promotion_support` + critic finding ref/hash as dynamic material; owner v1c bounded-debate runtime/admission services | `topic-selection.v1c.promotion-support.bounded-micro-debate.v1`; provider-canary profile remains canary-only; `TopicSelectionV1cBoundedMicroDebateRoleOrFinal@v1`; prior-role hash drift blocks admission |
| v1c N2 | `topic-selection.v1c.generate-promotion-support.v1` | `n2_bounded_micro_debate.synthesizer_final` | implemented L1-L3 through `TopicSelectionV1cN2BoundedDebateRuntimeService -> AgentOrchestrator`; admission recomputes expected runtime identity through the runtime service and emits a sealed admission identity/hash; admitted final output feeds `TopicSelectionV1cPromotionGateService.createPromotionDecisionSupportFromVerifiedRuntimeDraft` before explicit N3 gate creation | final advisory semantic layer before deterministic N3 promotion gate; only admitted support draft/dossier input, never gate authority; support replay key is bound to the admitted runtime identity hash | `v1c_n2_bounded_promotion_support` + role-output refs/hashes as dynamic material; owner v1c bounded-debate runtime/admission services; compression MUST preserve critic findings, critic resolution map, and readiness coverage items | `topic-selection.v1c.promotion-support.bounded-micro-debate.v1`; provider-canary profile remains canary-only; `TopicSelectionV1cBoundedMicroDebateRoleOrFinal@v1`; final prompt drift blocks with `N2_BOUNDED_DEBATE_ARTIFACT_PROMPT_DRIFT`; prompt-cache read-through and no-N3-bypass smoke passed |
