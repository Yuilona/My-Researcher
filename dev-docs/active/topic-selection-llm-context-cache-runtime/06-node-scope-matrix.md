...
| v1b N2 | `topic-selection.v1b.record-research-constraint-profile.v1` | `n2_constraint_profile_semantic_support` | frozen semantic artifact via `WorkflowHarness`; runtime promotion deferred by D26 | delegated payload candidate before deterministic gate | `v1b_constraint_profile_context`; owner TBD v1b semantic-support adapter | `ResearchConstraintProfileDraftSupport@v1` |
| v1b N3 | `topic-selection.v1b.assess-intake-readiness.v1` | `n3_readiness_classification` | frozen semantic artifact via `WorkflowHarness`; runtime promotion deferred by D26 | support only before deterministic readiness gate | `v1b_intake_readiness_context`; owner TBD v1b semantic-support adapter | `IntakeReadinessClassificationSupport@v1` |
...
| v1b N5 | `topic-selection.v1b.select-research-slice.v1` | `n5_slice_selection_review` | frozen semantic artifact via `WorkflowHarness`; runtime promotion deferred by D26 | delegated payload candidate before deterministic selection gate | `v1b_slice_selection_context`; owner TBD v1b semantic-support adapter | `ResearchSliceSelectionReviewSupport@v1` |
...
| v1c N2 | `topic-selection.v1c.generate-promotion-support.v1` | `n2_bounded_micro_debate.promotion_supporter_draft` | implemented L1-L5 local through `TopicSelectionV1cN2BoundedDebateRuntimeService -> AgentOrchestrator` plus admission through `TopicSelectionV1cN2BoundedDebateAdmissionService`; v1c harness and Prisma smoke now use this path; `TopicSelectionProviderCanaryService` covers this production runtime slot for local/live provider-required semantics | support-only draft before critic/repair/final synthesis; cannot create N3 gate, human decision, bridge, or recheck | `v1c_n2_bounded_promotion_support`; owner v1c bounded-debate runtime/admission services; MUST consume frozen N1 promotion input snapshot refs/hashes and preserve claim ceiling, evidence support map, risks, blockers, recheck hints, allowed refs, and source-health warnings | `topic-selection.v1c.promotion-support.bounded-micro-debate.v1`; provider-canary profile remains canary-only; `TopicSelectionV1cBoundedMicroDebateRoleOrFinal@v1`; prompt-index L3 smoke passed via `pnpm topic-selection:v1c-n2-runtime-smoke`; L4 provider canary uses slot-derived strict schema and L5 compression adversarial coverage passed |
| v1c N2 | `topic-selection.v1c.generate-promotion-support.v1` | `n2_bounded_micro_debate.reviewer_critic_review` | implemented L1-L5 local through `TopicSelectionV1cN2BoundedDebateRuntimeService -> AgentOrchestrator`; prior supporter draft artifact hash is dynamic material and admission-checked; `TopicSelectionProviderCanaryService` covers this production runtime slot for local/live provider-required semantics | support-only critique before repair/final synthesis; critic findings cannot become authority and must be resolved by final synthesis | `v1c_n2_bounded_promotion_support` + supporter draft ref/hash as dynamic material; owner v1c bounded-debate runtime/admission services; compression MUST preserve critic findings and allowed-ref/source context | `topic-selection.v1c.promotion-support.bounded-micro-debate.v1`; provider-canary profile remains canary-only; `TopicSelectionV1cBoundedMicroDebateRoleOrFinal@v1`; prompt packet identity includes prior-role hash material; L4 provider canary uses slot-derived strict schema and L5 compression adversarial coverage passed |
| v1c N2 | `topic-selection.v1c.generate-promotion-support.v1` | `n2_bounded_micro_debate.promotion_supporter_repair` | implemented L1-L5 local through `TopicSelectionV1cN2BoundedDebateRuntimeService -> AgentOrchestrator`; prior supporter/critic artifact hashes are dynamic material and admission-checked; `TopicSelectionProviderCanaryService` covers this production runtime slot for local/live provider-required semantics | support-only repair before final synthesis; repair actions cannot override deterministic N3 gate or allowed refs | `v1c_n2_bounded_promotion_support` + critic finding ref/hash as dynamic material; owner v1c bounded-debate runtime/admission services; compression MUST preserve prior role hashes, critic findings, allowed refs, risk/recheck facts | `topic-selection.v1c.promotion-support.bounded-micro-debate.v1`; provider-canary profile remains canary-only; `TopicSelectionV1cBoundedMicroDebateRoleOrFinal@v1`; prior-role hash drift blocks admission; L4 provider canary uses slot-derived strict schema and L5 compression adversarial coverage passed |
| v1c N2 | `topic-selection.v1c.generate-promotion-support.v1` | `n2_bounded_micro_debate.synthesizer_final` | implemented L1-L5 local through `TopicSelectionV1cN2BoundedDebateRuntimeService -> AgentOrchestrator`; admission recomputes expected runtime identity through the runtime service and emits a sealed admission identity/hash; admitted final output feeds `TopicSelectionV1cPromotionGateService.createPromotionDecisionSupportFromVerifiedRuntimeDraft` before explicit N3 gate creation; `TopicSelectionProviderCanaryService` covers this production runtime slot for local/live provider-required semantics | final advisory semantic layer before deterministic N3 promotion gate; only admitted support draft/dossier input, never gate authority; support replay key is bound to the admitted runtime identity hash | `v1c_n2_bounded_promotion_support` + role-output refs/hashes as dynamic material; owner v1c bounded-debate runtime/admission services; compression MUST preserve critic findings, critic resolution map, readiness coverage items, allowed refs, risk/recheck obligations, and source hashes | `topic-selection.v1c.promotion-support.bounded-micro-debate.v1`; provider-canary profile remains canary-only; `TopicSelectionV1cBoundedMicroDebateRoleOrFinal@v1`; final prompt drift blocks with `N2_BOUNDED_DEBATE_ARTIFACT_PROMPT_DRIFT`; prompt-cache read-through and no-N3-bypass smoke passed; L4 provider canary uses slot-derived strict schema and L5 compression adversarial coverage passed |
...
| v1c N6 | `topic-selection.v1c.downstream-feedback-recheck.v1` | `downstream_feedback_normalization` | registry/contracts foundation landed; service wiring deferred to N6 runtime/admission slice; Codex acceptance script and provider canary remain evidence-only until wired | normalized candidate before deterministic recheck creation | `v1c_n6_downstream_feedback_normalization`; owner future v1c feedback-normalization runtime adapter; compression MUST preserve bridge/source refs, feedback signal/severity, required action, affected or loopback target hint, no-upstream-mutation boundary, and allowed refs | `topic-selection.v1c.downstream-feedback-normalization.v1`; provider-canary profile remains canary-only; `TopicSelectionV1cDownstreamFeedbackCandidate@v1` |
...
- v1c provider canary slots: N2 bounded micro-debate supporter draft, reviewer critic, supporter repair, synthesizer final; N3 gate diagnostic adjunct; N4 delegated promotion decision; N6 downstream feedback normalization.
