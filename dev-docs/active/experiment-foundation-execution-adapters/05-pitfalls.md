...
- Result collection may create evidence only from `valid` or explicitly `accepted_partial` validation. It must not create paper claims, final conclusions, rendered tables, or leaderboard rows.
