...
## Status
- State: in-progress
- Next step: 围绕 `06-design-spec.md` 继续讨论并收敛鲁棒选题链路；同步更新 `roadmap.md` 的 open questions、milestones 与决策记录。

## Goal
- 创建并维护一个面向“完善选题链路”的任务包。
...
## Context
- `automated_topic_notes.md` 已形成对象链：`TopicSeed -> EvidenceMap -> ValidatedNeed -> ResearchSlice -> TopicQuestion -> TopicValueAssessment -> TopicPackage`。
