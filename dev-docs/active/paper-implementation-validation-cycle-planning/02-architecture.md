...
| Authority writer | validation planning service through `StateWriter` when available |
...
| Handoff | T-096 receives admitted work-order candidates with policy, trace, and portfolio context refs |
